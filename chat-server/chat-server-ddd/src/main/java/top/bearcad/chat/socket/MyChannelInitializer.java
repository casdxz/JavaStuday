package top.bearcad.chat.socket;

import io.netty.channel.ChannelInitializer;
import io.netty.channel.socket.SocketChannel;
import top.bearcad.chat.application.UserService;
import top.bearcad.chat.codec.ObjDecoder;
import top.bearcad.chat.codec.ObjEncoder;
import top.bearcad.chat.socket.handler.*;

/**
 * @program: chat-server
 * @description:
 * @author: bearcad
 * @create: 2021-11-09 00:55
 **/

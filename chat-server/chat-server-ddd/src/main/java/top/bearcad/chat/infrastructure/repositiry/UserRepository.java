...
import top.bearcad.chat.domain.user.model.*;
import top.bearcad.chat.domain.user.repository.IUserRepository;
import top.bearcad.chat.infrastructure.dao.*;
import top.bearcad.chat.infrastructure.po.*;

import java.util.ArrayList;
import java.util.List;

import static top.bearcad.chat.infrastructure.common.Constants.TalkType.Friend;
import static top.bearcad.chat.infrastructure.common.Constants.TalkType.Group;

/**
 * @program: chat-server
 * @description:
 * @author: bearcad
 * @create: 2021-11-09 00:46
 **/

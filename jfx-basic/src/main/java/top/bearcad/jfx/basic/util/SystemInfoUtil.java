package top.bearcad.jfx.basic.util;
...
SystemInfoUtil {
    ...
    public static JSONObject getCpuInfo() {
        ...
        //cpu当前温度
        cpuInfo.put("temp", HARDWARE_ABSTRACTION_LAYER.getSensors().getCpuTemperature());
        return cpuInfo;
    }
    ...
    public static void main(String[] args) {
        System.out.println(SystemInfoUtil.getCpuInfo());
    }
}

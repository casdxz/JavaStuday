package top.bearcad.jfx.basic.trayicon;
...
public class JavaFxTrayIconSample extends Application {
     ...
     * 托盘图标
     */
    private static final String ICON_IMAGE = "https://i.loli.net/2021/10/26/aO6QuqMLZe5SW7F.jpg";
    private Stage stage;
    ...
    private Node createContent() {
        ...
        hello.setStyle("-fx-font-size: 40px; -fx-text-fill: #40739e;");
        Label instructions = new Label("(click to hide)");
        instructions.setStyle("-fx-font-size: 24px; -fx-text-fill: #192a56; -fx-cursor: hand");
